...
<body>
            ...
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div class="menu-language items-center justify-between hidden w-full md:flex md:w-auto md:order-1"
                    ...
                    <ul
                        ...
                        <li class="relative">
                            <a href="#"
                                class="block services group py-2 pl-3 pr-4 text-white rounded hover:bg-gray-700 md:hover:bg-transparent md:hover:text-blue-500 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 ">บริการ</a>
                            <div
    ...
    <script>
        ...
        servicesEl.addEventListener('click', () => {
            setTimeout(() => {
                service_dropdown.classList.toggle("hidden")
            }, 200)
        })
